class View {
    ...
    finalRenderVersion(index, title, letter, urlDoc) {
        ...
        document.querySelector('#solidVersion' + index + 'Modal').innerHTML += '<div class="modal-dialog modal-dialog-centered modal-lg" role="document" id="solidVersion' + index + 'ModalInner"></div>';
        document.querySelector('#solidVersion' + index + 'ModalInner').innerHTML += '<div  class="modal-content" id="solidVersion' + index + 'ModalContent"></div>';
        document.querySelector('#solidVersion' + index + 'ModalContent').innerHTML += '<div class="modal-header"><h5 class="modal-title text-kover" id="solidVersion' + index + 'ModalTitle">' + title + '</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria - hidden = "true" > & times;</span></button></div >';
        document.querySelector('#solidVersion' + index + 'ModalContent .modal-header').innerHTML += '<button type="button" aria-label="Copier"> <span class="fa fa-clipboard" aria-hidden="true" data-copy="' + (index - 1) + '">COPIER</span></button>';
        document.querySelector('#solidVersion' + index + 'ModalContent .modal-header').innerHTML += '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden ="true">&times;</span></button>';
