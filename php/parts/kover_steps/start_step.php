...
<main
    ...
    <div class=" d-flex  flex-column flex-no-wrap flex-lg-wrap mx-auto">
        <p class="border-info text-info m-auto p-2 h3 rounded font-weight-bold mr-4">Touchez plus de cibles avec votre lettre de motivation&nbsp;!</p>
        <p class="text-dark h4 my-5 mx-4 mx-lg-auto mxtext-center">
            <span class="font-weight-bold">Adaptez-là à vos destinataires</span><br>
