    ...
    <div class="row">
        <div class="col-12 row">
            <div id="stockVersions" class="d-none">
                <div class="versionTitleBlock" data-version="1">
                    <h3 id="version1Title" class="versionTitle mt-3" data-version="1">Version Originale</h3>
                    <button class="badge versionTitleBadge" data-version="1">Modifier</button>
                </div>
        ...
        <div class="col-md-5 col-lg-4 order-first order-md-last align-self-start" id="versionsMenu">
            ...
            <div class="container-fluid">
                <div id="versionsButtons" class="row no-gutters d-flex flex-column my-2"></div>
