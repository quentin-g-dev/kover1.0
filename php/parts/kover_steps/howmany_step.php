 ...
 <main
    ...
    <input type="number" name="howManyLetters" id="howManyLetters" placeholder="1" min="1" max="5" step="1"
                class="my-3">
    <button class="btn bg-kover text-white rounded mx-auto mt-4 h1" id="howManyButton">OK</button>
</main>