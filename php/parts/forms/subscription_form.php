<main
        class="signUp container full-container d-flex flex-column p-3 mx-auto my-2 text-center w-100 w-lg-75 justify-content-start align-items-baseline h-100 rounded"
        id="signUp">    
    <h2 class="mt-0 mb-3 text-center mx-auto">Inscription</h2>
    <form action="post_subscription.php" method="post" id="signUpForm" class="d-flex flex-column justify-content-between align-items-center w-75 mw-100 mx-auto my-2" onsubmit="return evalSignUpForm();">
        ...
        <fieldset class="d-flex justify-content-center align-items-center mw-75 w-50 flex-nowrap mx-auto">
            <input required type="checkbox" name="acceptConditions" id="acceptConditions" value="accepted" class="w-25">
