...
<form action="./profile.php?vip=<?echo $vip->userId();?>" method="post" class="d-flex flex-column justify-content-between align-items-center w-75 mw-100 mx-auto mx-auto my-2"
    id="changeName">
